        ...
        if (user) {
          ...
          new Session({
            ...
            if (err) {
              ...
              var messagePlain = 'Hello ' + req.body.username.toLowerCase() + ', You recently requested a password reset for your LinkDrops account. If you didn\'t, please ignore this email. Here is your reset link: https://linkdrops.com/#/forgot/' + token;
              var messageHTML = 'Hello LinkDrops User!<br><br> You recently requested a password reset for your LinkDrops account. If you didn\'t, please ignore this email. <br><br>Here is your reset link: <br>https://linkdrops.com/#/forgot/' + token;
